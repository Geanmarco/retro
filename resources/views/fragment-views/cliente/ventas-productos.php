                                ...
                                <div class="form-group ">
                                    <div class="row" style="margin-right: 0;">
                                        <div class="row  col-lg-4">
                                            <label for="example-text-input" class="col-sm-4 col-form-label">Stock
                                                Actual</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="row  col-lg-3">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="" id="" class="form-control"
                                                        ...
                                                        vv-model="producto.precio_unidad">
                        ...
                        <div class="col-md-12 mt-5">
                            ...
                            <table class="table">
                                ...
                                <tr v-for="(item,index) in productos">
                                    ...
                                    <td>
                                        <span v-if="!item.edicion">{{item.precioVenta}}</span>
                                        <input v-if="item.edicion" v-model="item.precioVenta">
                                    </td>
                        ...
                        <div class="widget padding-0 white-bg">
                            <div class="padding-20 text-center">
                                <form v-on:submit.prevent role="form" class="form-horizontal">
                                    ...
                                    <!--<div class="form-group">
                                        <label class="col-lg-4 control-label">O.C</label>
                                        <div class="col-lg-12 row">
                                            <div class="col-lg-6">
                                                <input class="form-check-input" style="width: 23px;height: 23px"
                                                       type="checkbox" value="" id="miCheckbox">
                                            </div>
                                            <div class="col-lg-6">
                                                <input v-model="venta.oc" type="text"
                                                       class="form-control text-center" readonly="">
                                            </div>
                                        </div>
                                    </div>-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <input v-model="venta.oc" class="form-check-input"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <input v-model="venta.num_oc" type="text"
                                                                   class="form-control"
                                                                   :readonly="venta.oc === false"
                                                                   v-bind:required="venta.oc">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <input v-model="venta.tc" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            methods: {
                            ...
                            _post("/ajs/data/producto/info/code",
                                ...
                                function (resp) {
                                    ...
                                    if (resp.res) {
                                        ...
                                        app.producto.imagen = ui.item.imagen
                                        let array = [{
                ...
                onChangeAlmacen(event) {
                    ...
                    $("#input_buscar_productos").autocomplete({
                        ...
                        var listItem = $("<li>");
                        var div = $("<div class='center-y'>");
                        var imagen = onlyTrim(item.imagen) !== '' ? _URL + '/files/productos/' + item.imagen : _URL + '/public/img/cover-default.png';
                        div.append("<img src='" + imagen + "' style='width: 60px;margin-right: 10px'>");
                ...
                guardarVenta() {
                    if (this.productos.length > 0) {
                        ...
                        if (this.venta.oc && onlyTrim(this.venta.num_oc) === '') {
                            mensaje = 'Debes escribir el Numerod e ordend e compra !!!';
                            continuar = false;
                        }
                        /*console.log(mensaje);
